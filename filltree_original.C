...
void filltree(int runnum)
{
   ...
   if (fCalifa){
     std::cout << "filltree.C: sizeof=" << sizeof(EXT_STR_h101_CALIFA)<<"\n";

	unpackcalifa = new R3BCalifaFebexReader((EXT_STR_h101_CALIFA*)&ucesb_struct.califa, offsetof(EXT_STR_h101,califa));
	//unpackWRCalifa = new R3BWhiterabbitCalifaReader((EXT_STR_h101_WRCALIFA*)&ucesb_struct.wrcalifa, offsetof(EXT_STR_h101, wrcalifa), 0xa00, 0xb00);
   }
    // Add readers ------------------------------------------
